...
class BlackjackGUI(Frame):
	...
	def _hit(self):
		"""Hit the player in the data model and updates its card pane. If the player points reach or exceed 21, hits the dealer too."""
		...
		label.grid(row = 0, column = len(self._playerLabels))
		if points >= 21:
